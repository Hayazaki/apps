...
<link rel="shortcut icon" href="<?php echo base_url('assets/template/')?>dist/img/wifi.png" type="image/x-icon">
<link rel="icon" href="<?php echo base_url('assets/template/')?>dist/img/wifi.png" type="image/x-icon">
