    ...
    <div class="row">
      <div class="col-md-8">
        <div class="box box-success">
          ...
          <!-- /.box-header -->
          <?php echo form_open('ap/masuk/edit/'.$apmasuk['id']); ?>
          <div class="box-body">
            ...
            <div class="alert alert-danger alert-dismissible">
              ...
              <div class="box-body">
                ...
                <div class="form-group <?php if(form_error('serial_number')) echo 'has-error';?>">
                  ...
                  <input type="text" name="serial_number" value="<?php echo ($this->input->post('serial_number') ? $this->input->post('serial_number') : $apmasuk['serial_number']); ?>" class="form-control" placeholder="Contoh: KWC212XXXXX" />
                ...
                <div class="form-group <?php if(form_error('mac_address')) echo 'has-error';?>">
                  ...
                  <input type="text" name="mac_address" value="<?php echo ($this->input->post('mac_address') ? $this->input->post('mac_address') : $apmasuk['mac_address']); ?>" class="form-control" placeholder="Contoh: B83861XXXXXX" />
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="jenis_ap" value="<?php echo ($this->input->post('jenis_ap') ? $this->input->post('jenis_ap') : $apmasuk['jenis_ap']); ?>" class="form-control" placeholder="Contoh: AIR-AP1832I-F-K9" />
                </div>
                </div>
                <div class="col-md-6">
                <div class="form-group <?php if(form_error('kondisi')) echo 'has-error';?>">
                  ...
                  <select name="kondisi" class="form-control">
                    <option value="<?php echo $apmasuk['kondisi']; ?>">-- Pilih --</option>
                    <?php
                ...
                <div class="form-group">
                  ...
                  <textarea type="text" name="keterangan" class="form-control" id="keterangan"><?php echo ($this->input->post('keterangan') ? $this->input->post('keterangan') : $apmasuk['keterangan']); ?></textarea>
                </div>
                </div>
                <div class="col-md-12">
                <div class="form-group">
